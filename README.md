...
Parks API is a web services project developed collaboratively by a team of CS students. It exposes a RESTful API for accessing and managing park-related data, demonstrating core concepts of web service architecture, HTTP methods, and data handling.

---

## ✨ Features

- 🔗 RESTful endpoints for park data
- 📦 Structured JSON responses
- 🧪 Built following web services best practices
...
- **Backend:** [Add your language/framework, e.g. Python/Flask, Java/Spring, Node.js]
- **Data:** [Add your data source or database]
...
**`NOTE:`** You can always clone this repository. However, if you do, you need to remove the `.git` **_hidden_** directory before you copy this template over to `htdocs`
...
Built by a team of 5th semester CS students at Vanier College.
...
<p align="center">Built at <a href="https://www.vaniercollege.qc.ca">Vanier College</a> · Montréal, QC</p>
